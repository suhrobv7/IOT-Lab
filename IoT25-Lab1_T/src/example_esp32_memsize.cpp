...
void printPartitionInfo() {
  ...
  // Print the partition table and partition metadata.
...
void setup() {
  ...
  // PSRAM information for boards with external RAM.
  Serial.println("\n--- PSRAM ---");
  ...
  // Current running partition information.
